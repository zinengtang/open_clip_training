...
def parse_args(args):
    ...
    parser.add_argument(
        "--logs-path",
        type=str,
        default="/scratch/partial_datasets/mvbench/logs/",
    ...
    parser.add_argument(
        "--epochs-steps", type=int, default=32, help="Number of steps in an epoch to train for."
    )
    parser.add_argument(
    ...
    def load_dataset_config(yaml_file):
        """
    ...
    # Set dataset arguments from the config
    args.train_data = dataset_config.get('train_data')
    # args.val_data = dataset_config.get('val_data')
