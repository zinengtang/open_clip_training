...
model_name_to_checkpoint = {
    ...
    "tulip-so400m-patch14-384": "/home/terran/timm-ckpt/tulip-so400m-14-384.ckpt",
...
def convert_siglip_checkpoint(model_name, pytorch_dump_folder_path, verify_logits=True, push_to_hub=False):
    ...
    tokenizer = AutoTokenizer.from_pretrained("ZinengTang/tulip-tokenizer", token="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")
